...
function getAllCourses(): Course[] {
  // If you wired courses elsewhere: read from localStorage if present.
  // This keeps it simple and resilient during v0 preview.
...
export default function Page() {
  ...
  // Next's useParams returns a string here (for single param), but be safe:
